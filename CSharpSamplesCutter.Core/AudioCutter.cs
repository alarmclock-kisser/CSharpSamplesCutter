...
namespace CSharpSamplesCutter.Core
{
	public static class AudioCutter
	{
		...
		/// <summary>
		/// Schneidet automatisch möglichst unterschiedliche Sample-Segmente aus einem AudioObj.
		/// 1. Optionaler Sekunden-Trim
		/// 2. Onset/Segment-Erkennung über vereinfachte Energie-Hüllkurve (Mono)
		/// 3. Clustering ähnlicher Segmente (Cosine Similarity auf Fingerprints) -> Mergen
		/// 4. Auswahl der repräsentativen, unterschiedlichen Segmente (Energy & Diversity)
		/// </summary>
