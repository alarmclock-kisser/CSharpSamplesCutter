...
namespace CSharpSamplesCutter.Forms.Dialogs
{
	public partial class LoadDialog : Form
	{
		...
		public LoadDialog(AudioObj? originalAudio = null)
		{
			...
			if (this.OriginalAudio != null)
			{
				...
				this.numericUpDown_count.Value = Math.Clamp((int) this.OriginalAudio.Duration.TotalMinutes * 30, this.numericUpDown_count.Minimum, this.numericUpDown_count.Maximum);
			}
		...
		private void textBox_path_Leave(object sender, EventArgs e)
		{
			...
			if (this.Duration != null)
			{
				...
				this.numericUpDown_endTime.Value = this.numericUpDown_endTime.Maximum;
				this.numericUpDown_count.Value = Math.Clamp((int) (this.Duration.Value.TotalMinutes * 30), this.numericUpDown_count.Minimum, this.numericUpDown_count.Maximum);
